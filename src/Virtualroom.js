...
//   const zoomSpeed = 0.3; // Adjust zoom speed
...
//       const targetZoom = Math.max(controlsRef.current.minZoom, Math.min(controlsRef.current.maxZoom, controlsRef.current.zoom - zoomLevel));
//       controlsRef.current.zoom += (targetZoom - controlsRef.current.zoom) * zoomSpeed;
...
//       if (event.key === 'w') {
//         setZoomLevel((prev) => prev + 0.3); // Zoom in
//       } else if (event.key === 's') {
//         setZoomLevel((prev) => prev - 0.3); // Zoom out
//       }
//     };
...
//       <Model />
//       <OrbitControls ref={controlsRef} enableDamping dampingFactor={0.3} />
//     </Canvas>
//   );
// }
...
//   // This component represents an object in your scene that you want to be able to drag.
//   // Replace the geometry and material with your desired object.
//   const meshRef = useRef();

//   const { mouse } = useThree();

//   useFrame(() => {
//     // Example of moving an object with the mouse position
//     // You could replace this with more complex dragging logic
//     if (meshRef.current) {
//       meshRef.current.position.x += (mouse.x * 10 - meshRef.current.position.x) * 0.1;
//       meshRef.current.position.y += (-mouse.y * 10 - meshRef.current.position.y) * 0.1;
//     }
//   });
//   return (
